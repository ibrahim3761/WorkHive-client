...
const ExtraSections = () => {
  return (
    <div className="w-full">
      ...
      >
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-gray-700 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
            Join as a worker to complete micro tasks or become a buyer and post
            your tasks.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto">
            {[
              ...
              },
              {
                ...
                text: "Buyers post tasks, workers browse opportunities",
                color: "from-purple-100 to-purple-50",
              },
              {
                icon: "💰",
                title: "3. Earn & Grow",
                text: "Complete tasks and withdraw earnings",
        ...
        <div className="container mx-auto px-4 md:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-blue-100 text-lg md:text-xl mb-10 leading-relaxed">
              Are you an agency, company, or digital entrepreneur? Partner with
              WorkHive to reach thousands of micro-workers and scale your
      ...
      <motion.div
        className="w-full py-10 bg-gradient-to-br from-blue-50 to-white"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeIn}
      ...
      >
        <div className="container mx-auto mt-5 px-4 md:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-10">
            Why People Love WorkHive
          </h2>
            ...
            {[
              {
                icon: "⚡",
                title: "Fast & Reliable",
                text: "Connect with skilled workers instantly and get tasks done in record time.",
              },
              {
                icon: "🌐",
                title: "Global Talent Pool",
                text: "Access a diverse network of workers from different regions and industries.",
              },
              {
                icon: "🔒",
                title: "Secure Payments",
                text: "We ensure safe transactions so both clients and workers can focus on results.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <motion.div
        className="w-full py-10 bg-gradient-to-br from-yellow-50 to-white"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeIn}
      ...
      >
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-yellow-900 mb-10">
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: "🤝",
                title: "Trust",
                text: "We ensure secure, transparent, and fair dealings for all users.",
              },
              {
                icon: "⚡",
                title: "Efficiency",
                text: "We focus on quick task completion without compromising quality.",
              },
              {
                icon: "🌱",
                title: "Growth",
                text: "Helping both buyers and workers scale their capabilities and reach.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
                className="bg-gradient-to-br from-white to-yellow-50 p-8 rounded-2xl shadow-lg border border-white"
                variants={featureCardVariants}
                whileHover="hover"
              >
                <div className="text-5xl mb-5">{item.icon}</div>
